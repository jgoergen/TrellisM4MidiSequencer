...
#define DEFAULT_BPM         120   //increase for faster tempo
...
uint32_t lightBlue =      0x000077;
uint32_t green =          0x00FF00;
uint32_t teal =           0x00FFFF;
uint32_t magenta =        0xFF00FF;
uint32_t lightMagenta =   0x770077;
uint32_t yellow =         0xFFFF00;
uint32_t off =            0x000000;
uint32_t offColor =       blue; // color of deactivated buttons
uint32_t offColorBlack =  lightBlue; // color of deactivated buttons that represent black keys
uint32_t onColor =        magenta; // color of activated buttons
uint32_t onColorBlack =   lightMagenta; // color of activated buttons that represent black keys
